...
Revisa el archivo data/conn.js para asegurarte de que la conexión a la base de datos sea correcta. Si el proyecto usa un archivo .env, crea uno en la raíz de tp-final-wnode con las variables necesarias (ej. PORT, MONGO_URI).
